...
class StudentRegistrationModal extends Component {
    state = { 
        show: false,
        ...
        return (
          <>
            ...
            <Modal show={this.state.show} onHide={this.handleClose}>
              ...
              <Modal.Body>
                {window.location.hostname}/#/student-register/{this.state.registration_key}
              </Modal.Body>
            </Modal>
          </>
        );
...
export default connect()(StudentRegistrationModal);
