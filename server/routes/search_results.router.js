...
router.get('/', async (req, res) => {
    ...
    try {
        let query = `SELECT m.*, license_type.title AS license_title,
			...
			m.telehealth, m.statement, m.website, m.title, m.city, m.city_personal, m.license_number,m.student, m.license_type, m.enabled;`;
...
router.get("/:zip", async (req, res) => {
  ...
  try {
	...
	m.license_expiration, m.hiamft_member_account_info, m.supervision_Status, m.fees, m.credentials,
	m.telehealth, m.statement, m.website, m.title, m.city, m.license_number, m.license_type, m.enabled, m.zip_code_personal, m.city_personal;`;
